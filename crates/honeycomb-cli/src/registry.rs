...
use honeycomb_cli_claude::ClaudeDriver;
use honeycomb_cli_codex::CodexDriver;
use honeycomb_cli_cursor::CursorDriver;
use honeycomb_cli_worker_bee::WorkerBeeDriver;
...
/// 从 `PtyBackendConfig` 风格字段解析有效预设（供 honeycomb-core 调用）。
